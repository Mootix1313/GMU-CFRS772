...
class BinFile:
    ...
    '''
    def __init__ (self, filename, searchTerm):
    ...
    def __str__(self):
        return "\nfilename = %s, filetype = binary, searchTerm = %s" %(self.filename, self.searchTerm)
    
    def findSearchTerm(self):
...
class TextFile:
    ...
    def __str__(self):
        return "\nfilename = %s, filetype = text, searchTerm = %s" %(self.filename, self.searchTerm)
